...
<div class="container">
    <div class="row form-container">
      ...
      <div class="col-md-6 form-left">
        <form action="{{ route('pemilihan.update') }}" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="text" id="nama_kandidat" class="form-control" required value="{{ $kandidat->nama_kandidat }}" readonly>
             </div>
          <div class="mb-3">
      ...
      <div class="col-md-6 form-right">
        ...
        <select name="nama_pemilih" id="nama_pemilih" class="form-control">
          ...
          <div class="mb-3">
            ...
            <input type="date" name="waktu_memilih" id="time" class="form-control" required> 
       </div>
      </div>
    </div>
